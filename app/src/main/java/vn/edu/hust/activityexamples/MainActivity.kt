...
class MainActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    studentList.add("Nguyễn Văn An - SV001")
    studentList.add("Trần Thị Bảo - SV002")
    studentList.add("Lê Hoàng Cường - SV003")
    studentList.add("Phạm Thị Dung - SV004")
    studentList.add("Đỗ Minh Đức - SV005")
